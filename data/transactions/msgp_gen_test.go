...
func TestMarshalUnmarshalGroupEnvelop(t *testing.T) {
	v := GroupEnvelop{}
	bts := v.MarshalMsg(nil)
	left, err := v.UnmarshalMsg(bts)
	if err != nil {
...
func TestRandomizedEncodingGroupEnvelop(t *testing.T) {
	protocol.RunEncodingTest(t, &GroupEnvelop{})
}

func BenchmarkMarshalMsgGroupEnvelop(b *testing.B) {
	v := GroupEnvelop{}
	b.ReportAllocs()
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkAppendMsgGroupEnvelop(b *testing.B) {
	v := GroupEnvelop{}
	bts := make([]byte, 0, v.Msgsize())
	bts = v.MarshalMsg(bts[0:0])
	b.SetBytes(int64(len(bts)))
...
func BenchmarkUnmarshalGroupEnvelop(b *testing.B) {
	v := GroupEnvelop{}
	bts := v.MarshalMsg(nil)
	b.ReportAllocs()
	b.SetBytes(int64(len(bts)))
