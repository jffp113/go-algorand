	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0005 > 0 {
			...
			if zb0016 > config.MaxAppProgramLen {
				err = msgp.ErrOverflow(uint64(zb0016), uint64(config.MaxAppProgramLen))
				return
			}
		...
		if zb0005 > 0 {
			...
			if zb0017 > config.MaxAppProgramLen {
				err = msgp.ErrOverflow(uint64(zb0017), uint64(config.MaxAppProgramLen))
				return
			}
		...
		for zb0005 > 0 {
			...
			case "apap":
				...
				if zb0027 > config.MaxAppProgramLen {
					err = msgp.ErrOverflow(uint64(zb0027), uint64(config.MaxAppProgramLen))
					return
				}
				(*z).ApprovalProgram, bts, err = msgp.ReadBytesBytes(bts, (*z).ApprovalProgram)
				if err != nil {
			...
			case "apsu":
				...
				if zb0028 > config.MaxAppProgramLen {
					err = msgp.ErrOverflow(uint64(zb0028), uint64(config.MaxAppProgramLen))
					return
				}
				(*z).ClearStateProgram, bts, err = msgp.ReadBytesBytes(bts, (*z).ClearStateProgram)
				if err != nil {
...
func (z *ApplicationCallTxnFields) Msgsize() (s int) {
	...
	s += 5 + (*z).LocalStateSchema.Msgsize() + 5 + (*z).GlobalStateSchema.Msgsize() + 5 + msgp.BytesPrefixSize + len((*z).ApprovalProgram) + 5 + msgp.BytesPrefixSize + len((*z).ClearStateProgram)
	return
}

// MsgIsZero returns whether this is a zero value
func (z *ApplicationCallTxnFields) MsgIsZero() bool {
	return ((*z).ApplicationID.MsgIsZero()) && ((*z).OnCompletion == 0) && (len((*z).ApplicationArgs) == 0) && (len((*z).Accounts) == 0) && (len((*z).ForeignApps) == 0) && (len((*z).ForeignAssets) == 0) && ((*z).LocalStateSchema.MsgIsZero()) && ((*z).GlobalStateSchema.MsgIsZero()) && (len((*z).ApprovalProgram) == 0) && (len((*z).ClearStateProgram) == 0)
}
...
// MarshalMsg implements msgp.Marshaler
func (z *GroupEnvelop) MarshalMsg(b []byte) (o []byte) {
	o = msgp.Require(b, z.Msgsize())
	// omitempty: check for empty values
	zb0001Len := uint32(3)
	var zb0001Mask uint8 /* 4 bits */
...
func (_ *GroupEnvelop) CanMarshalMsg(z interface{}) bool {
	_, ok := (z).(*GroupEnvelop)
	return ok
}

// UnmarshalMsg implements msgp.Unmarshaler
func (z *GroupEnvelop) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 int
	var zb0002 bool
...
func (_ *GroupEnvelop) CanUnmarshalMsg(z interface{}) bool {
	_, ok := (z).(*GroupEnvelop)
	return ok
}

// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z *GroupEnvelop) Msgsize() (s int) {
	s = 1 + 7 + msgp.BytesPrefixSize + len((*z).PublicKey) + 4 + msgp.BytesPrefixSize + len((*z).Signature) + 7 + msgp.StringPrefixSize + len((*z).Scheme)
	return
}

// MsgIsZero returns whether this is a zero value
func (z *GroupEnvelop) MsgIsZero() bool {
	return (len((*z).PublicKey) == 0) && (len((*z).Signature) == 0) && ((*z).Scheme == "")
}
...
func (z *SignedTxn) MarshalMsg(b []byte) (o []byte) {
	...
	if zb0001Len != 0 {
		if (zb0001Mask & 0x2) == 0 { // if not empty
			// string "gsig"
			o = append(o, 0xa4, 0x67, 0x73, 0x69, 0x67)
			o = (*z).GroupSignature.MarshalMsg(o)
		}
		if (zb0001Mask & 0x4) == 0 { // if not empty
			// string "lsig"
...
func (z *SignedTxn) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0001 > 0 {
			zb0001--
			bts, err = (*z).GroupSignature.UnmarshalMsg(bts)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "GroupSignature")
				return
			}
		}
		if zb0001 > 0 {
		...
		for zb0001 > 0 {
			...
			case "gsig":
				bts, err = (*z).GroupSignature.UnmarshalMsg(bts)
				if err != nil {
					err = msgp.WrapError(err, "GroupSignature")
					return
				}
			default:
				err = msgp.ErrNoField(string(field))
...
func (z *SignedTxn) Msgsize() (s int) {
	s = 1 + 4 + (*z).Sig.Msgsize() + 5 + (*z).Msig.Msgsize() + 5 + (*z).Lsig.Msgsize() + 4 + (*z).Txn.Msgsize() + 5 + (*z).AuthAddr.Msgsize() + 5 + (*z).GroupSignature.Msgsize()
	return
}

// MsgIsZero returns whether this is a zero value
func (z *SignedTxn) MsgIsZero() bool {
	return ((*z).Sig.MsgIsZero()) && ((*z).Msig.MsgIsZero()) && ((*z).Lsig.MsgIsZero()) && ((*z).Txn.MsgIsZero()) && ((*z).AuthAddr.MsgIsZero()) && ((*z).GroupSignature.MsgIsZero())
}
...
func (z *SignedTxnInBlock) MarshalMsg(b []byte) (o []byte) {
	...
	if (*z).SignedTxnWithAD.SignedTxn.GroupSignature.MsgIsZero() {
		zb0001Len--
		zb0001Mask |= 0x80
	}
	...
	if zb0001Len != 0 {
		...
		if (zb0001Mask & 0x80) == 0 { // if not empty
			// string "gsig"
			o = append(o, 0xa4, 0x67, 0x73, 0x69, 0x67)
			o = (*z).SignedTxnWithAD.SignedTxn.GroupSignature.MarshalMsg(o)
		}
...
func (z *SignedTxnInBlock) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0001 > 0 {
			zb0001--
			bts, err = (*z).SignedTxnWithAD.SignedTxn.GroupSignature.UnmarshalMsg(bts)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "GroupSignature")
				return
			}
...
func (z *SignedTxnInBlock) Msgsize() (s int) {
	s = 1 + 4 + (*z).SignedTxnWithAD.SignedTxn.Sig.Msgsize() + 5 + (*z).SignedTxnWithAD.SignedTxn.Msig.Msgsize() + 5 + (*z).SignedTxnWithAD.SignedTxn.Lsig.Msgsize() + 4 + (*z).SignedTxnWithAD.SignedTxn.Txn.Msgsize() + 5 + (*z).SignedTxnWithAD.SignedTxn.AuthAddr.Msgsize() + 5 + (*z).SignedTxnWithAD.SignedTxn.GroupSignature.Msgsize() + 3 + (*z).SignedTxnWithAD.ApplyData.ClosingAmount.Msgsize() + 4 + msgp.Uint64Size + 3 + (*z).SignedTxnWithAD.ApplyData.SenderRewards.Msgsize() + 3 + (*z).SignedTxnWithAD.ApplyData.ReceiverRewards.Msgsize() + 3 + (*z).SignedTxnWithAD.ApplyData.CloseRewards.Msgsize() + 3 + (*z).SignedTxnWithAD.ApplyData.EvalDelta.Msgsize() + 4 + msgp.BoolSize + 4 + msgp.BoolSize
	return
}

// MsgIsZero returns whether this is a zero value
func (z *SignedTxnInBlock) MsgIsZero() bool {
	return ((*z).SignedTxnWithAD.SignedTxn.Sig.MsgIsZero()) && ((*z).SignedTxnWithAD.SignedTxn.Msig.MsgIsZero()) && ((*z).SignedTxnWithAD.SignedTxn.Lsig.MsgIsZero()) && ((*z).SignedTxnWithAD.SignedTxn.Txn.MsgIsZero()) && ((*z).SignedTxnWithAD.SignedTxn.AuthAddr.MsgIsZero()) && ((*z).SignedTxnWithAD.SignedTxn.GroupSignature.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.ClosingAmount.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.AssetClosingAmount == 0) && ((*z).SignedTxnWithAD.ApplyData.SenderRewards.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.ReceiverRewards.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.CloseRewards.MsgIsZero()) && ((*z).SignedTxnWithAD.ApplyData.EvalDelta.MsgIsZero()) && ((*z).HasGenesisID == false) && ((*z).HasGenesisHash == false)
}
...
func (z *SignedTxnWithAD) MarshalMsg(b []byte) (o []byte) {
	...
	if (*z).SignedTxn.GroupSignature.MsgIsZero() {
		zb0001Len--
		zb0001Mask |= 0x40
	}
	...
	if zb0001Len != 0 {
		...
		if (zb0001Mask & 0x40) == 0 { // if not empty
			// string "gsig"
			o = append(o, 0xa4, 0x67, 0x73, 0x69, 0x67)
			o = (*z).SignedTxn.GroupSignature.MarshalMsg(o)
		}
		if (zb0001Mask & 0x80) == 0 { // if not empty
			// string "lsig"
			o = append(o, 0xa4, 0x6c, 0x73, 0x69, 0x67)
...
func (z *SignedTxnWithAD) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0001 > 0 {
			zb0001--
			bts, err = (*z).SignedTxn.GroupSignature.UnmarshalMsg(bts)
			if err != nil {
				err = msgp.WrapError(err, "struct-from-array", "GroupSignature")
				return
			}
	...
	if _, ok := err.(msgp.TypeError); ok {
		...
		if zb0006 > 0 {
			...
			if zb0018 > config.MaxAppProgramLen {
				err = msgp.ErrOverflow(uint64(zb0018), uint64(config.MaxAppProgramLen))
				return
			}
		...
		if zb0006 > 0 {
			...
			if zb0019 > config.MaxAppProgramLen {
				err = msgp.ErrOverflow(uint64(zb0019), uint64(config.MaxAppProgramLen))
				return
			}
		...
		for zb0006 > 0 {
			...
			case "apap":
				...
				if zb0030 > config.MaxAppProgramLen {
					err = msgp.ErrOverflow(uint64(zb0030), uint64(config.MaxAppProgramLen))
					return
				}
				(*z).ApplicationCallTxnFields.ApprovalProgram, bts, err = msgp.ReadBytesBytes(bts, (*z).ApplicationCallTxnFields.ApprovalProgram)
				if err != nil {
			...
			case "apsu":
				...
				if zb0031 > config.MaxAppProgramLen {
					err = msgp.ErrOverflow(uint64(zb0031), uint64(config.MaxAppProgramLen))
					return
				}
				(*z).ApplicationCallTxnFields.ClearStateProgram, bts, err = msgp.ReadBytesBytes(bts, (*z).ApplicationCallTxnFields.ClearStateProgram)
				if err != nil {
